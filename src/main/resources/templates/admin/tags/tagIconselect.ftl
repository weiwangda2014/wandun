...
<div id="icons">
    ...
    <ul class="the-icons">
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-0"></i> battery-0 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-1"></i> battery-1 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-2"></i> battery-2 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-3"></i> battery-3 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-4"></i> battery-4 <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-grab-o"></i> hand-grab-o <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-stop-o"></i> hand-stop-o <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass"></i> hourglass</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-1"></i> hourglass-1 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-2"></i> hourglass-2 <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-3"></i> hourglass-3 <span class="text-muted">(alias)</span>
        </li>
    ...
    <ul class="the-icons">
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-automobile"></i> automobile <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-balance-scale"></i> balance-scale</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ban"></i> ban</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bank"></i> bank <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart"></i> bar-chart</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart-o"></i> bar-chart-o <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cab"></i> cab <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-clone"></i> clone</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-close"></i> close <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dashboard"></i> dashboard <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-edit"></i> edit <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-feed"></i> feed <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-movie-o"></i> file-movie-o <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-pdf-o"></i> file-pdf-o</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-photo-o"></i> file-photo-o <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-picture-o"></i> file-picture-o <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-powerpoint-o"></i> file-powerpoint-o</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-sound-o"></i> file-sound-o <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-zip-o"></i> file-zip-o <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-flash"></i> flash <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gear"></i> gear <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gears"></i> gears <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-group"></i> group <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-grab-o"></i> hand-grab-o <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-lizard-o"></i> hand-lizard-o</li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hotel"></i> hotel <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass"></i> hourglass</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-1"></i> hourglass-1 <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-start"></i> hourglass-start</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-i-cursor"></i> i-cursor</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-image"></i> image <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-institution"></i> institution <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-legal"></i> legal <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-bouy"></i> life-bouy <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-buoy"></i> life-buoy <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-ring"></i> life-ring</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-saver"></i> life-saver <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-forward"></i> mail-forward <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply"></i> mail-reply <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply-all"></i> mail-reply-all <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mobile-phone"></i> mobile-phone <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mortar-board"></i> mortar-board <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-navicon"></i> navicon <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-photo"></i> photo <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-registered"></i> registered</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-remove"></i> remove <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reorder"></i> reorder <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send"></i> send <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send-o"></i> send-o <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-soccer-ball-o"></i> soccer-ball-o <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-down"></i> sort-down <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-up"></i> sort-up <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-empty"></i> star-half-empty <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-full"></i> star-half-full <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-support"></i> support <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-down"></i> toggle-down <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-left"></i> toggle-left <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-right"></i> toggle-right <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-up"></i> toggle-up <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-trademark"></i> trademark</li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unsorted"></i> unsorted <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-warning"></i> warning <span
                    class="text-muted">(alias)</span></li>
    ...
    <ul class="the-icons">
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-genderless"></i> genderless</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-intersex"></i> intersex <span
                    class="text-muted">(alias)</span></li>
    ...
    <ul class="the-icons">
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bitcoin"></i> bitcoin <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-btc"></i> btc</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cny"></i> cny <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dollar"></i> dollar <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eur"></i> eur</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-euro"></i> euro <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-money"></i> money</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rmb"></i> rmb <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rouble"></i> rouble <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rub"></i> rub</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ruble"></i> ruble <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rupee"></i> rupee <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shekel"></i> shekel <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sheqel"></i> sheqel <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-try"></i> try</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-turkish-lira"></i> turkish-lira <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usd"></i> usd</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-won"></i> won <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yen"></i> yen <span class="text-muted">(alias)</span>
        </li>
    </ul>
    ...
    <ul class="the-icons">
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chain"></i> chain <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-copy"></i> copy <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cut"></i> cut <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dedent"></i> dedent <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eraser"></i> eraser</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file"></i> file</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-o"></i> file-o</li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paste"></i> paste <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-repeat"></i> repeat</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-left"></i> rotate-left <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-right"></i> rotate-right <span class="text-muted">(alias)</span>
        </li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-save"></i> save <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unlink"></i> unlink <span
                    class="text-muted">(alias)</span></li>
    </ul>
    ...
    <ul class="the-icons">
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-facebook-f"></i> facebook-f <span class="text-muted">(alias)</span>
        </li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gittip"></i> gittip <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wechat"></i> wechat <span
                    class="text-muted">(alias)</span></li>
        ...
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-y-combinator"></i> y-combinator</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-y-combinator-square"></i> y-combinator-square <span
                    class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yahoo"></i> yahoo</li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yc"></i> yc <span class="text-muted">(alias)</span></li>
        <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yc-square"></i> yc-square <span class="text-muted">(alias)</span>
        </li>
