...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-table@1.9.1/dist/bootstrap-table.min.css">
    ...
    <link rel="stylesheet" href="${static}/css/style.min.css?v=4.1.0">
</head>
...
<div id="wrapper">
                        ...
                        <@shiro.authenticated>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs">
                                   <strong class="font-bold"><@shiro.principal  property="name"/></strong>
                               </span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="${admin}/login.html">安全退出</a>
                                </li>
                            </ul>
                        </@shiro.authenticated>
                    </div>
                    <div class="logo-element"><img src="${setting.logo}" alt="${setting.siteName}" class="img-circle"/>
                    </div>
                </li>
                <@menus method="menus">
                                ...
                                <li>
                                    <#if (foo.grade==1)>
                                        <a href="#"><i class="fa fa-home"></i><span
                                                    class="nav-label">${foo.name}</span><span
                                                    class="fa arrow"></span></a>
                                    </#if>
                                    <ul class="nav ${foo.level}">
                                        <#if foo.children?exists>
                                        <#list foo.children as child>
                                            <#if (child.grade==2)>
                                                <li>
                                                    <a class="J_menuItem" href="${admin}${child.href}"
                                                       data-index="0">${child.name}</a>
                                                </li>
                                            </#if>
                                            <@dumpFoo child />
                                        </#list>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${admin}/home?v=4.0" frameborder="0"
                    data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right"> ${copyright} <a href="${site}" target="_blank">${name}</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap-table@1.9.1/dist/bootstrap-table.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.1/dist/jquery.validate.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.1/dist/localization/messages_zh.min.js"></script>
...
<script src="https://cdn.jsdelivr.net/npm/metismenu@2.7.9/dist/metisMenu.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jquery-slimscroll@1.3.8/jquery.slimscroll.min.js"></script>
<!-- 自定义js -->
<script type="text/javascript" src="${static}/js/wandun.min.js?v=4.1.0"></script>
